...
func (*ListDeploymentRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*ListDeploymentResponse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*GetDeploymentRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*GetLatestDeploymentRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{3} }
...
func (*Deployment) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{4} }
...
func (*StartDeploymentResponse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{5} }
...
func (*GetDeploymentStatusRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{6} }
...
func (*GetDeploymentStatusResponse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{7} }
...
func (*TeardownDeploymentRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{8} }
...
func init() { proto1.RegisterFile("deployment.proto", fileDescriptor3) }
