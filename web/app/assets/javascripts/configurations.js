(function(window) {
	...
	const list = props.pairs.map((pair, i) => {
	    return (
		div({className: "config-var-pair form-inline mb-2"},
		    Name({name: "configuration[names][]", value: pair[0], readOnly: true}),
		    Value({name: "configuration[values][]", value: pair[1], readOnly: true}),
